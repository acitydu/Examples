...
/* ---------- 预加载 ---------- */
	...
	'static/img/05-bg.jpg',
	'static/img/05-triangle.png',
	'static/img/06-bg.jpg',
	'static/img/06-triangle.png',
	'static/img/07-bg.jpg',
	'static/img/07-triangle.png',
    'static/img/01-bg_07.png',
	],function(){  
		$('.loading').remove();
		$('.p-index').show();
		$('.player-button').show();
